...
public class Onyx extends ServerManager {

    private static final String serverAddress = "144.217.11.36";
    private static final int port = 43594;

    private final BigInteger RSA_MODULUS = new BigInteger("", 16);
    private final BigInteger RSA_EXPONENT = new BigInteger("10001");


    public Onyx(String username, String password, Stream stream, Stream inStream, Stream aStream_847, Store store, boolean flag, RSSocket rsSocket) throws IOException {
