package aniski.rs.net;// Decompiled by Jad v1.5.8f. Copyright 2001 Pavel Kouznetsov.
...
public final class RSSocket implements Runnable {
    ...
    public RSSocket(Socket socket1) {
        try {
            ...
            socket = socket1;
            // originally 30000
            socket.setSoTimeout(8000); // 8 Seconds time-out
           // socket.setSoLinger(true, 5000);
            //socket.setKeepAlive(false);
            //socket.setReuseAddress(true); // Added to Reuse the Address
    ...
    public void startRunnable(Runnable runnable, int priority) {
        ...
        thread.setUncaughtExceptionHandler((t1, e) -> close());
        thread.start();
